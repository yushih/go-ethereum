...
// (D)J
func doubleToRawLongBits(frame *rtda.Frame, gas uint64, contract interface{}, evm interface{}) {
...
// (J)D
func longBitsToDouble(frame *rtda.Frame, gas uint64, contract interface{}, evm interface{}) {
