...
func canonicalize0(frame *rtda.Frame, gas uint64, contract interface{}, evm interface{}) {
...
// (Ljava/io/File;)I
func getBooleanAttributes0(frame *rtda.Frame, gas uint64, contract interface{}, evm interface{}) {
	vars := frame.LocalVars()
	f := vars.GetRef(1)
	path := _getPath(f)
