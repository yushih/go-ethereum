...
// ()Ljava/lang/Class;
func getCallerClass(frame *rtda.Frame, gas uint64, contract interface{}, evm interface{}) {
...
// (Ljava/lang/Class;)I
func getClassAccessFlags(frame *rtda.Frame, gas uint64, contract interface{}, evm interface{}) {
