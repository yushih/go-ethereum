...
func _unsafe(method func(frame *rtda.Frame, gas uint64, contract interface{}, evm interface{}), name, desc string) {
	native.Register("sun/misc/Unsafe", name, desc, method)
}

// public native long allocateMemory(long bytes);
// (J)J
func allocateMemory(frame *rtda.Frame, gas uint64, contract interface{}, evm interface{}) {
...
// (JJ)J
func reallocateMemory(frame *rtda.Frame, gas uint64, contract interface{}, evm interface{}) {
	vars := frame.LocalVars()
	// vars.GetRef(0) // this
...
// (J)V
func freeMemory(frame *rtda.Frame, gas uint64, contract interface{}, evm interface{}) {
	vars := frame.LocalVars()
	// vars.GetRef(0) // this
	address := vars.GetLong(1)
	free(address)
...
// (J)B
func mem_getByte(frame *rtda.Frame, gas uint64, contract interface{}, evm interface{}) {
...
// (JJ)V
func mem_putLong(frame *rtda.Frame, gas uint64, contract interface{}, evm interface{}) {
	vars := frame.LocalVars()
	// vars.GetRef(0) // this
	address := vars.GetLong(1)
