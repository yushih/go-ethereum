...
func (self *RETURN) Execute(frame *rtda.Frame, gas uint64) uint64 {
...
func (self *ARETURN) Execute(frame *rtda.Frame, gas uint64) uint64 {
	thread := frame.Thread()
...
func (self *DRETURN) Execute(frame *rtda.Frame, gas uint64) uint64 {
	thread := frame.Thread()
	currentFrame := thread.PopFrame()
	invokerFrame := thread.TopFrame()
...
func (self *FRETURN) Execute(frame *rtda.Frame, gas uint64) uint64 {
	thread := frame.Thread()
	currentFrame := thread.PopFrame()
	invokerFrame := thread.TopFrame()
...
func (self *IRETURN) Execute(frame *rtda.Frame, gas uint64) uint64 {
	thread := frame.Thread()
	currentFrame := thread.PopFrame()
	invokerFrame := thread.TopFrame()
...
func (self *LRETURN) Execute(frame *rtda.Frame, gas uint64) uint64 {
	thread := frame.Thread()
	currentFrame := thread.PopFrame()
	invokerFrame := thread.TopFrame()
